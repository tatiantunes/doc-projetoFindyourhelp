...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">find-your-help documentation</a>
                </li>
                    ...
                    <li class="chapter modules">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="modules-links"' : 'id="xs-modules-links"' }>
                            <li class="link">
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-c84fedadcf88c35c666342efe68cd62c"' : 'data-target="#xs-components-links-module-AppModule-c84fedadcf88c35c666342efe68cd62c"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-c84fedadcf88c35c666342efe68cd62c"' :
                                            'id="xs-components-links-module-AppModule-c84fedadcf88c35c666342efe68cd62c"' }>
                                            <li class="link">
                                ...
                                <li class="chapter inner">
                                    <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                        'data-target="#directives-links-module-AppModule-c84fedadcf88c35c666342efe68cd62c"' : 'data-target="#xs-directives-links-module-AppModule-c84fedadcf88c35c666342efe68cd62c"' }>
                                        <span class="icon ion-md-code-working"></span>
                                        <span>Directives</span>
                                        <span class="icon ion-ios-arrow-down"></span>
                                    </div>
                                    <ul class="links collapse" ${ isNormalMode ? 'id="directives-links-module-AppModule-c84fedadcf88c35c666342efe68cd62c"' :
                                        'id="xs-directives-links-module-AppModule-c84fedadcf88c35c666342efe68cd62c"' }>
                                        <li class="link">
